...
})(PS["Example.Driver.Websockets.Log"] = PS["Example.Driver.Websockets.Log"] || {});
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
...
(function($PS) {
  ...
  "use strict";
  $PS["Example.Driver.Websockets.Log"] = $PS["Example.Driver.Websockets.Log"] || {};
  var exports = $PS["Example.Driver.Websockets.Log"];
  var $foreign = $PS["Example.Driver.Websockets.Log"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  ...
  var OutputMessage = (function () {
      function OutputMessage(value0) {
          this.value0 = value0;
      };
      OutputMessage.create = function (value0) {
          return new OutputMessage(value0);
      };
  ...
  var HandleInputSearch = (function () {
      function HandleInputSearch(value0) {
          this.value0 = value0;
      };
      HandleInputSearch.create = function (value0) {
          return new HandleInputSearch(value0);
      };
  ...
  var TurnFilter = (function () {
      function TurnFilter() {

      };
      TurnFilter.value = new TurnFilter();
      return TurnFilter;
  })();
  var PauseResume = (function () {
      ...
      PauseResume.value = new PauseResume();
      return PauseResume;
  })();
  var Clear = (function () {
      function Clear() {
  ...
  var SlideWindow = (function () {
      function SlideWindow(value0) {
          this.value0 = value0;
      };
      SlideWindow.create = function (value0) {
          return new SlideWindow(value0);
      };
      return SlideWindow;
  })();
  var updateText = function (st) {
      return function (ev) {
          var messagesSource = (function () {
              if (st.searchResult instanceof Data_Maybe.Nothing) {
                  return st.messages;
              };
              if (st.searchResult instanceof Data_Maybe.Just) {
                  return st.searchResult.value0;
              };
              throw new Error("Failed pattern match at Example.Driver.Websockets.Log (line 293, column 28 - line 295, column 50): " + [ st.searchResult.constructor.name ]);
          })();
          var something = (function () {
              var v = Data_Array.index(messagesSource)(ev);
              if (v instanceof Data_Maybe.Just) {
                  return v.value0.full;
              };
              if (v instanceof Data_Maybe.Nothing) {
                  return "(NULL)";
              };
              throw new Error("Failed pattern match at Example.Driver.Websockets.Log (line 296, column 23 - line 298, column 47): " + [ v.constructor.name ]);
          })();
          return {
              ...
              paused: st.paused,
              filter: st.filter,
              currentWindowStart: st.currentWindowStart,
              searchResult: st.searchResult,
  ...
  var $$switch = function (v) {
      ...
      throw new Error("Failed pattern match at Example.Driver.Websockets.Log (line 287, column 1 - line 287, column 29): " + [ v.constructor.name ]);
  };
  var runSearch = function (st) {
      var result = Data_Array.filter(function (a) {
          return !Data_Eq.eq(Data_Maybe.eqMaybe(Data_Eq.eqInt))(Data_String_CodePoints.indexOf(st.searchText)(a.full))(Data_Maybe.Nothing.value);
      })(st.messages);
  ...
  var initialState = function (v) {
      return {
          ...
          paused: false,
          filter: false,
          searchResult: Data_Maybe.Nothing.value,
      ...
      return function (v) {
          ...
          if (v instanceof HandleInputSearch) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (v1) {
                  ...
                  $38.searchText = v.value0;
                  return $38;
              });
          };
          if (v instanceof Submit) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(dictMonadEffect))(Web_Event_Event.preventDefault(v.value0)))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Halogen_Query_HalogenM.raise(new OutputMessage(st.inputText)))(function () {
                          return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st$prime) {
                              var $42 = {};
                              for (var $43 in st$prime) {
                                  if ({}.hasOwnProperty.call(st$prime, $43)) {
                                      $42[$43] = st$prime[$43];
                                  };
                              };
                              $42.inputText = "";
          ...
          if (v instanceof SlideWindow) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st$prime) {
                  var $46 = {};
                  for (var $47 in st$prime) {
                      if ({}.hasOwnProperty.call(st$prime, $47)) {
                          $46[$47] = st$prime[$47];
                      };
                  };
                  $46.currentWindowStart = Data_Ord.max(Data_Ord.ordInt)(0)(Data_Ord.min(Data_Ord.ordInt)(st$prime.currentWindowStart + v.value0 | 0)(Data_Array.length(st$prime.messages) - 1 | 0));
                  return $46;
              });
          };
          if (v instanceof RunSearch) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st$prime) {
                  return {
                      searchResult: runSearch(st$prime),
                      currentWindowStart: st$prime.currentWindowStart,
                      filter: st$prime.filter,
                      inputText: st$prime.inputText,
                      messages: st$prime.messages,
                      paused: st$prime.paused,
                      searchText: st$prime.searchText,
                      selectedIndex: st$prime.selectedIndex,
                      selectedText: st$prime.selectedText
                  };
              });
          };
          if (v instanceof Select) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st$prime) {
                  return updateText(st$prime)(v.value0);
              });
          };
              ...
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.get(Halogen_Query_HalogenM.monadStateHalogenM))(function (st) {
                      var onoff = "filter" + (function () {
                          ...
                          throw new Error("Failed pattern match at Example.Driver.Websockets.Log (line 267, column 29 - line 269, column 50): " + [ st.filter.constructor.name ]);
                      })();
          ...
          if (v instanceof Clear) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $58.messages = [  ];
                  $58.currentWindowStart = 0;
                  $58.searchResult = Data_Maybe.Nothing.value;
                  return $58;
              });
          };
          if (v instanceof ClearSearch) {
              return Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
                  ...
                  $61.searchResult = Data_Maybe.Nothing.value;
                  return $61;
              });
          };
          throw new Error("Failed pattern match at Example.Driver.Websockets.Log (line 226, column 16 - line 276, column 53): " + [ v.constructor.name ]);
      };
  };
  ...
  var new_entry = function (r) {
      return {
          summary: r.summary,
          full: r.full,
          index: 0,
          etype: entry_type_json(r.etype)
      };
  };
  var entry_type = function (etype) {
      if (etype instanceof Other) {
          return "other";
      };
      if (etype instanceof Recv) {
          return "recv";
      };
      if (etype instanceof Send) {
          return "sentpacket";
      };
      if (etype instanceof Log) {
          return "log";
      };
      throw new Error("Failed pattern match at Example.Driver.Websockets.Log (line 217, column 3 - line 221, column 20): " + [ etype.constructor.name ]);
  };
  ...
  var render = function (state) {
      var window = Data_Int.toStringAs(Data_Int.decimal)(state.currentWindowStart);
      var slide_button_sub = Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
          return new SlideWindow(-2500 | 0);
      }) ])([ Halogen_HTML_Core.text("-2500") ]);
      var slide_button = Halogen_HTML_Elements.button([ Halogen_HTML_Events.onClick(function (v) {
          return new SlideWindow(2500);
      }) ])([ Halogen_HTML_Core.text("+2500") ]);
      ...
      return Halogen_HTML_Elements.div_([ form, Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("float-container") ])([ Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("packets"), Halogen_HTML_Properties.id_()("packets") ])(Data_Functor.map(Data_Functor.functorArray)(function (msg) {
          ...
          }) ])([ Halogen_HTML_Core.text(msg.txt) ]);
      })(msgs)), Halogen_HTML_Elements.div([ Halogen_HTML_Properties.class_("float-child") ])([ Halogen_HTML_Elements.textarea([ Halogen_HTML_Properties.value(state.selectedText) ]) ]) ]) ]);
  };
  var append_msg = function (incomingMessage) {
      return function (st) {
          var v = Simple_JSON.readJSON(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons({
          ...
          })(Simple_JSON.readString)(Simple_JSON.readFieldsNil)()())()())()()))(incomingMessage);
          if (v instanceof Data_Either.Right) {
              var nentry = new_entry(v.value0);
              var $71 = Data_Array.length(st.messages) > 100000;
              if ($71) {
                  return st;
              };
              return {
                  messages: Data_Array.snoc(st.messages)(nentry),
                  inputText: st.inputText,
                  selectedIndex: st.selectedIndex,
                  selectedText: st.selectedText,
                  paused: st.paused,
                  filter: st.filter,
                  currentWindowStart: st.currentWindowStart,
                  searchResult: st.searchResult,
          ...
          throw new Error("Failed pattern match at Example.Driver.Websockets.Log (line 308, column 3 - line 316, column 9): " + [ v.constructor.name ]);
      };
  };
  var handleQuery = function (v) {
      var incomingMessage = $foreign.scrollBottomImpl(v.value0);
      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Control_Monad_State_Class.modify_(Halogen_Query_HalogenM.monadStateHalogenM)(function (st) {
          return append_msg(incomingMessage)(st);
      }))(function () {
          var x = $foreign.scrollBottomImpl("something");
...
(function($PS) {
  // Generated by purs version 0.14.5
  "use strict";
  $PS["Example.Driver.Websockets.Main"] = $PS["Example.Driver.Websockets.Main"] || {};
  var exports = $PS["Example.Driver.Websockets.Main"];
  var Control_Applicative = $PS["Control.Applicative"];
  var Control_Bind = $PS["Control.Bind"];
  var Control_Coroutine = $PS["Control.Coroutine"];
  ...
  var Effect_Aff = $PS["Effect.Aff"];
  var Effect_Class = $PS["Effect.Class"];
  var Example_Driver_Websockets_Log = $PS["Example.Driver.Websockets.Log"];
  var Foreign = $PS["Foreign"];
  ...
  var wsSender = function (socket) {
      return function (v) {
          return Web_Socket_WebSocket.sendString(socket)(v.value0);
      };
  };
  var wsProducer = function (socket) {
      var readHelper = function (read) {
          var $3 = Data_Either.either(Data_Function["const"](Data_Maybe.Nothing.value))(Data_Maybe.Just.create);
          return function ($4) {
              return $3(Control_Monad_Except.runExcept(read(Foreign.unsafeToForeign($4))));
          };
      };
      return Control_Coroutine_Aff.produce(function (emitter) {
          return function __do() {
              var onOpen = Web_Event_EventTarget.eventListener(function (ev) {
                  return Web_Socket_WebSocket.sendString(socket)("start_listening");
              })();
              var listener = Web_Event_EventTarget.eventListener(function (ev) {
              ...
              Web_Event_EventTarget.addEventListener(Web_Socket_Event_EventTypes.onOpen)(onOpen)(false)(Web_Socket_WebSocket.toEventTarget(socket))();
              return Web_Event_EventTarget.addEventListener(Web_Socket_Event_EventTypes.onMessage)(listener)(false)(Web_Socket_WebSocket.toEventTarget(socket))();
          };
      });
  };
  var wsConsumer = function (query) {
      return Control_Coroutine.consumer(Effect_Aff.monadAff)(function (msg) {
          return Control_Bind.discard(Control_Bind.discardUnit)(Effect_Aff.bindAff)(Data_Functor["void"](Effect_Aff.functorAff)(query(Halogen_Query.mkTell(Example_Driver_Websockets_Log.ReceiveMessage.create(msg)))))(function () {
              return Control_Applicative.pure(Effect_Aff.applicativeAff)(Data_Maybe.Nothing.value);
          });
      });
  };
  var main = function __do() {
      var connection = Web_Socket_WebSocket.create("ws://127.0.0.1:30110/ws")([  ])();
      return Halogen_Aff_Util.runHalogenAff(Control_Bind.bind(Effect_Aff.bindAff)(Halogen_Aff_Util.awaitBody)(function (body) {
          return Control_Bind.bind(Effect_Aff.bindAff)(Halogen_VDom_Driver.runUI(Example_Driver_Websockets_Log.component(Effect_Aff.monadEffectAff))(Data_Unit.unit)(body))(function (io) {
              return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Halogen_Subscription.subscribe(io.messages)(wsSender(connection))))(function () {
                  return Control_Coroutine.runProcess(Effect_Aff.monadRecAff)(Control_Coroutine.connect(Effect_Aff.monadRecAff)(Effect_Aff.parallelAff)(wsProducer(connection))(wsConsumer(io.query)));
              });
          });
      }))();
  };
...
PS["Example.Driver.Websockets.Main"].main();